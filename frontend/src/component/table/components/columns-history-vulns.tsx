...
import { DataTableRowProjectActions } from './row-actions-history-vulns'

export const vulnsColumns: ColumnDef<Repository>[] = [
    {
    ...
    },
    {
        ...
        cell: ({ row }) => {
            ...
            return (
                <div className="min-w-[80px] max-w-[200px] line-clamp-2 font-medium">
