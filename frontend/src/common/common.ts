...
export const PULL_REQUEST_SUCCESS_MESSAGE = 'Create pull request to fix successfully'
export const SECURITY_ADVISORY_SUCCESS_MESSAGE = 'Create security advisory successfully'
